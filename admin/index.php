...
<div class="login-nav-outer">
	<ul class="login-hmenu">
		...
		<li>
			<a href="index.php?id=4" <?php if ((isset($_GET['id'])) && ($_GET['id'] == 4)) { echo "class='active'"; } ?>><span class="l"></span><span class="r"></span><span class="t">Reklama</span></a>
		</li>	
		<li>
			<a href="index.php?id=5" <?php if ((isset($_GET['id'])) && ($_GET['id'] == 5)) { echo "class='active'"; } ?>><span class="l"></span><span class="r"></span><span class="t">Konta</span></a>
		</li>	
...
<div class="login-post-inner login-article">
  ...
  if ((isset($_GET['id'])) && ($_GET['id'] == 4)) { include('reklama.php'); };
  if ((isset($_GET['id'])) && ($_GET['id'] == 5)) { include('konta.php'); };
