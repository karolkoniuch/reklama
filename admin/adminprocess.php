...
class AdminProcess
{
   ...
   function checkUsername($uname, $ban=false){
      ...
      if(!$subuser || strlen($subuser = trim($subuser)) == 0){
         ...
         if(strlen($subuser) < $config['min_user_chars'] || strlen($subuser) > $config['max_user_chars'] ||
            !preg_match("/^[a-z0-9]([0-9a-z_-])+$/i", $subuser) ||
   ...
   function procConfigEdit(){
      ...
      $retval = $session->editConfigs($_POST['sitename'], $_POST['sitedesc'], $_POST['emailfromname'], $_POST['adminemail'], $_POST['webroot'], $_POST['home_page'], $_POST['activation'], $_POST['min_user_chars'], $_POST['max_user_chars'], $_POST['min_pass_chars'], $_POST['max_pass_chars'], $_POST['send_welcome'], $_POST['enable_login_question'], $_POST['enable_capthca'], $_POST['all_lowercase'], $_POST['cookie_expiry'], $_POST['cookie_path']);
