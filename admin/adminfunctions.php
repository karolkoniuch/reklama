...
<?php
   ...
   function displayUsers(){
      ...
      $sql = $this->connection->query("SELECT username,userlevel,email,timestamp,licencja FROM ".TBL_USERS." ORDER BY userlevel DESC,username");
      $count = $sql->rowCount();
     ...
     for($i=0; $i<$num_rows; $i++){
      ...
      $licka   = mysql_result($result,$i,"licencja");
      $timet  = date("F j, Y, g:i a", $time);   
      $timetxt  = date("F j, Y, g:i a", $licka);
